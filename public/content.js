...
<path d="m465.016 0h-344.456c-9.52 0-17.223 7.703-17.223 17.223v86.114h-86.114c-9.52 0-17.223 7.703-17.223 17.223v344.456c0 9.52 7.703 17.223 17.223 17.223h344.456c9.52 0 17.223-7.703 17.223-17.223v-86.114h86.114c9.52 0 17.223-7.703 17.223-17.223v-344.456c0-9.52-7.703-17.223-17.223-17.223zm-120.56 447.793h-310.01v-310.01h310.011v310.01zm103.337-103.337h-68.891v-223.896c0-9.52-7.703-17.223-17.223-17.223h-223.896v-68.891h310.011v310.01z"/>
				...
				function appendButton(node, btn) {
					var _a, _b;
					(_b = (_a = node.parentNode) === null || _a === void 0 ? void 0 : _a.parentNode) === null || _b === void 0
						? void 0
						: _b.appendChild(btn);
				}
  ...
  \*****************************/
			/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				const getVideoSrc = (articleNode, videoElem) =>
				...
				function postGetUrl(articleNode) {
					return __awaiter(this, void 0, void 0, function* () {
						...
						if (list.length === 0) {
							...
							const dotsList: HTMLDivElement = articleNode.querySelectorAll(
								`:scope > div > div:nth-child(${isPostView ? 1 : 2}) > div > div:nth-child(2)>div`
							);
							...
							if (url === null) {
								...
								const positionsMap = listElements.reduce((result, element) => {
									...
									const position = Math.round(
										Number((_a = element.style.transform.match(/-?(\d+)/)) === null || _a === void 0 ? void 0 : _a[1]) / listElementWidth
									);
  ...
  \******************************/
			/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
					/* ! dayjs */ './node_modules/.pnpm/dayjs@1.11.7/node_modules/dayjs/dayjs.min.js'
				);
				...
				const getUrlFromInfoApi = (articleNode, mediaIdx = 0) =>
					__awaiter(void 0, void 0, void 0, function* () {
						try {
				...
				const handleUrlDownload = (url, node) => {
					...
					downloadResource(
						url,
						posterName + '-' + dayjs__WEBPACK_IMPORTED_MODULE_0___default()(postTime).format('YYYYMMDD_HHmmss') + '-' + mediaName
					);
				};
				/***/
			},
